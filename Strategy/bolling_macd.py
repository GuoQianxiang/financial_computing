...
def plot_MA(df, ticker, principle):
    # 绘制折线图
    ...
    ax2 = ax.twinx()
    # 在第二个坐标轴上画图
    ax2.plot(df['Date'], df['balance']/principle, label='balance', color='orange')
    ...
    plt.savefig('../Output/balance/' + ticker + '.png', dpi=300)
    # 显示图表
    plt.show()
